combine -M MultiDimFit -n   both_allyear datacard_both_allyear.txt  -s 314159 -t 1000 --expectSignal 1 --redefineSignalPOIs r,nonPromptSF

#combine -M MultiDimFit -n   both_allyear datacard_both_allyear.txt  -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  >& outputFiles/file10.txt
