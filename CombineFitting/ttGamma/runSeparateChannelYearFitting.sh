...
combine -M MultiDimFit -n   el_2016 datacard_ele_2016.txt -s 314159 -t 1000 --expectSignal 1  --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file1.txt
combine -M MultiDimFit -n   mu_2016 datacard_mu_2016.txt  -s 314159 -t 1000 --expectSignal 1  --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file2.txt 

combine -M MultiDimFit -n   el_2017 datacard_ele_2017.txt -s 314159 -t 1000 --expectSignal 1  --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file3.txt 
combine -M MultiDimFit -n   mu_2017 datacard_mu_2017.txt  -s 314159 -t 1000 --expectSignal 1  --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file4.txt 

combine -M MultiDimFit -n   el_2018 datacard_ele_2018.txt -s 314159 -t 1000 --expectSignal 1  --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file5.txt 
combine -M MultiDimFit -n   mu_2018 datacard_mu_2018.txt  -s 314159 -t 1000 --expectSignal 1  --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file6.txt 

#combine -M MultiDimFit -n   el_2016 datacard_ele_2016.txt -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file1.txt
#combine -M MultiDimFit -n   mu_2016 datacard_mu_2016.txt  -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file2.txt 

#combine -M MultiDimFit -n   el_2017 datacard_ele_2017.txt -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file3.txt 
#combine -M MultiDimFit -n   mu_2017 datacard_mu_2017.txt  -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file4.txt 

#combine -M MultiDimFit -n   el_2018 datacard_ele_2018.txt -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file5.txt 
#combine -M MultiDimFit -n   mu_2018 datacard_mu_2018.txt  -s 314159 -t 1000 --expectSignal 1 --trackParameters PhoEff,Q2,PU,EleEff,BTagSF_b,lumi,BTagSF_l,MuEff,nonPromptSF --redefineSignalPOIs r,nonPromptSF -v2  #>& outputFiles/file6.txt 
