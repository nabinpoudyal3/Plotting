...
combine datacard_both_2016.root -M FitDiagnostics -V -n .datacard_both_2016 --toys=-1 --expectSignal=1 --seed=314159 --redefineSignalPOIs=r,nonPromptSF -v1 --rMin=0 --rMax=5   --cminDefaultMinimizerStrategy 0
...
combine -M FitDiagnostics -V -n .Asimov_both_2016 datacard_both_2016.root --seed=314159 --redefineSignalPOIs=r,nonPromptSF --saveWithUncertainties --saveNormalizations --saveToys  --plots --saveNLL --rMin=0 --rMax=5  --expectSignal=1 -t -1 -v1 --skipBOnlyFit --cminDefaultMinimizerStrategy 0


combine -M FitDiagnostics -V -n both_2016 datacard_both_2016.root --plots --saveNLL  --robustFit=1 -s 314159 --redefineSignalPOIs r,nonPromptSF --saveOverallShapes --saveWithUncertainties --saveNormalizations -v1 --rMin=0 --rMax=5   --skipBOnlyFit 
#python mlfitNormsToText.py fitDiagnosticsboth_2016.root --uncertainties

combine -M FitDiagnostics -V -n .TOY_both_2016 datacard_both_2016.root --seed=314159 --saveWithUncertainties --saveNormalizations --saveToys  --plots --saveNLL --rMin=0 --rMax=5  --expectSignal=1 -t 500 -v3 --skipBOnlyFit --trackParameters r,BTagSF_b,BTagSF_l,EleEff,MuEff,PhoEff,lumi,misIDE,ZGSF,TTbarSF,OtherSF,WGSF,nonPromptSF >& /dev/null 
