...
for channel in ${CHANNEL[@]}; do
    ...
    combine datacard_"$channel"_2016.root -M FitDiagnostics -n .datacard_"$channel"_2016 $myAsimovFit  $mySeed $mySignalParamters $verbose $mySignalModifierRange   $myParameterRange
    python diffNuisances.py fitDiagnostics.datacard_"$channel"_2016.root --all 

    combine datacard_"$channel"_2016.root -M FitDiagnostics -n .datacard_"$channel"_2016 $myFakeDataFit $mySeed $mySignalParamters $verbose $mySignalModifierRange   $myParameterRange
    python diffNuisances.py fitDiagnostics.datacard_"$channel"_2016.root --all 
    ...
    combine -M MultiDimFit datacard_"$channel"_2016.root $mySeed $myFakeDataFit --algo grid $myPoints -n .Main $mySignalModifierRange    $myParameterRange
    combine -M MultiDimFit datacard_"$channel"_2016.root $mySeed $myFakeDataFit --saveWorkspace -n .snapshot $mySignalModifierRange     $myParameterRange
    ...
    python plot1DScan.py  higgsCombine.Main.MultiDimFit.mH120.314159.root --others 'higgsCombine.freezeAll.MultiDimFit.mH120.314159.root:Stat:2' --breakdown Syst,Stat -o freeze_"$channel"_2016_Data 
    ...
    combine -M FitDiagnostics -n "$channel"_2016 datacard_"$channel"_2016.root $myFakeDataFit --plots --saveNLL --robustFit=1 $mySeed $mySignalParamters --saveShapes --saveWithUncertainties --saveNormalizations $verbose $mySignalModifierRange  $myParameterRange --skipBOnlyFit
    python mlfitNormsToText.py fitDiagnostics"$channel"_2016.root --uncertainties

    combine -M FitDiagnostics -n .TOY_"$channel"_2016 datacard_"$channel"_2016.root $mySeed --saveWithUncertainties --saveNormalizations --saveToys  --plots --saveNLL $mySignalModifierRange  $myParameterRange $myToyFit -v3 --skipBOnlyFit $myTrackParameters 

    # no need to redefine POIs r and nonPromptSF but use the range for nonPromptSF 
    combineTool.py -M Impacts -d datacard_"$channel"_2016.root -m 125  --doInitialFit                 $myAsimovFit  --robustFit=1 $mySignalModifierRange  $myParameterRange 
    combineTool.py -M Impacts -d datacard_"$channel"_2016.root -m 125  --doFits                       $myAsimovFit  --robustFit=1 $mySignalModifierRange  $myParameterRange  --parallel 24
    combineTool.py -M Impacts -d datacard_"$channel"_2016.root -m 125  -o impacts_toy_"$channel"_2016.json   $myAsimovFit  --robustFit=1 $mySignalModifierRange  $myParameterRange 
    plotImpacts.py -i impacts_toy_"$channel"_2016.json -o impacts_toy_"$channel"_2016 

    combineTool.py -M Impacts -d datacard_"$channel"_2016.root -m 125  --doInitialFit                 $myFakeDataFit  --robustFit=1   $mySignalModifierRange  $myParameterRange 
    combineTool.py -M Impacts -d datacard_"$channel"_2016.root -m 125  --doFits                       $myFakeDataFit  --robustFit=1   $mySignalModifierRange  $myParameterRange  --parallel 24
    combineTool.py -M Impacts -d datacard_"$channel"_2016.root -m 125  -o impacts_data_"$channel"_2016.json  $myFakeDataFit  --robustFit=1   $mySignalModifierRange  $myParameterRange 
