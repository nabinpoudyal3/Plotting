...
myParameterRange=" --setParameterRanges nonPromptSF=0,5:WGSF=0,5:OtherSF=0,5:Other_norm=0,5:ZGSF=0,5:SingleTopSF=0,2 "
mySignalParamters=" --redefineSignalPOIs=r,nonPromptSF,TTbarSF "
mySignalModifierRange=" --rMin=0 --rMax=0.1 "
myExpectSignal=" --expectSignal 0.02 "
myAsimovFit=" -t -1 --expectSignal 0.02 "
# myFakeDataFit=" -t 1 --expectSignal 0.02 "
myFakeDataFit=" "
myToyFit=" -t 100 --expectSignal 0.02 "
verbose=" -v2 "
...
set -x
    ...
    combine --cminPreScan --skipBOnlyFit --forceRecreateNLL -M FitDiagnostics -n .Asimov_"$channel"_2016 datacard_"$channel"_2016.root $mySeed   --saveOverallShapes     --plots --saveNLL   $mySignalParamters --saveShapes --saveWithUncertainties --saveNormalizations  $mySignalModifierRange  $myParameterRange $myAsimovFit                   $verbose 
    combine --cminPreScan --skipBOnlyFit --forceRecreateNLL -M FitDiagnostics -n "$channel"_2016         datacard_"$channel"_2016.root $mySeed   --saveOverallShapes     --plots --saveNLL   $mySignalParamters --saveShapes --saveWithUncertainties --saveNormalizations  $mySignalModifierRange  $myParameterRange $myExpectSignal $myFakeDataFit $verbose 
    # combine --cminPreScan --skipBOnlyFit --forceRecreateNLL -M FitDiagnostics -n .TOY_"$channel"_2016    datacard_"$channel"_2016.root $mySeed                           --plots --saveNLL   $mySignalParamters              --saveWithUncertainties --saveNormalizations  $mySignalModifierRange  $myParameterRange $myToyFit                      -v3   
    ...
    combineTool.py  --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  --doInitialFit                        $myAsimovFit    --robustFit=1   $mySignalModifierRange  $myParameterRange 
    combineTool.py  --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  --doFits                              $myAsimovFit    --robustFit=1   $mySignalModifierRange  $myParameterRange  --parallel 24
    combineTool.py  --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  -o impacts_toy_"$channel"_2016.json   $myAsimovFit    --robustFit=1   $mySignalModifierRange  $myParameterRange 
    ...
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  --doInitialFit                                   $myAsimovFit --redefineSignalPOIs   TTbarSF    --robustFit=1   $mySignalModifierRange  $myParameterRange 
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  --doFits                                         $myAsimovFit --redefineSignalPOIs   TTbarSF    --robustFit=1   $mySignalModifierRange  $myParameterRange  --parallel 24
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  -o impacts_toy_"$channel"_2016_TTbarSF.json      $myAsimovFit --redefineSignalPOIs   TTbarSF    --robustFit=1   $mySignalModifierRange  $myParameterRange 
    ...
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  --doInitialFit                                   $myFakeDataFit --redefineSignalPOIs   TTbarSF --robustFit=1 $myExpectSignal  $mySignalModifierRange  $myParameterRange 
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  --doFits                                         $myFakeDataFit --redefineSignalPOIs   TTbarSF --robustFit=1 $myExpectSignal  $mySignalModifierRange  $myParameterRange  --parallel 24
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2016.root -m 125  -o impacts_data_"$channel"_2016_TTbarSF.json     $myFakeDataFit --redefineSignalPOIs   TTbarSF --robustFit=1 $myExpectSignal  $mySignalModifierRange  $myParameterRange 
