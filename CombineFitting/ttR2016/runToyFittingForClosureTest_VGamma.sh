...
if [[ $i == "0.4" ]]; then 
        ...
        echo $x
        if [[ $btag == "no0BtagCR" ]]; then 
                combine -M MultiDimFit -n el_2016_WGammaSF_no0BtagCR_$i datacard_ele_2016.txt --setParameters WGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
                combine -M MultiDimFit -n mu_2016_WGammaSF_no0BtagCR_$i datacard_mu_2016.txt  --setParameters WGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
                combine -M MultiDimFit -n el_2016_ZGammaSF_no0BtagCR_$i datacard_ele_2016.txt --setParameters ZGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
                combine -M MultiDimFit -n mu_2016_ZGammaSF_no0BtagCR_$i datacard_mu_2016.txt  --setParameters ZGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&      
        else
                combine -M MultiDimFit -n el_2016_WGammaSF_$i datacard_ele_2016.txt           --setParameters WGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
                combine -M MultiDimFit -n mu_2016_WGammaSF_$i datacard_mu_2016.txt            --setParameters WGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
                combine -M MultiDimFit -n el_2016_ZGammaSF_$i datacard_ele_2016.txt           --setParameters ZGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
                combine -M MultiDimFit -n mu_2016_ZGammaSF_$i datacard_mu_2016.txt            --setParameters ZGammaSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&   
