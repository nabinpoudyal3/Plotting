...
if [[ $i == "0.4" ]]; then 
        ...
        echo $x
        if [[ $btag == "no0BtagCR" ]]; then 
                combine -M MultiDimFit -n el_2018_WGSF_no0BtagCR_$i datacard_ele_2018.root  --setParameters WGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,WGSF -v3&
                combine -M MultiDimFit -n mu_2018_WGSF_no0BtagCR_$i datacard_mu_2018.root   --setParameters WGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,WGSF -v3&
                combine -M MultiDimFit -n el_2018_ZGSF_no0BtagCR_$i datacard_ele_2018.root  --setParameters ZGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,ZGSF -v3&
                combine -M MultiDimFit -n mu_2018_ZGSF_no0BtagCR_$i datacard_mu_2018.root   --setParameters ZGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,ZGSF -v3&      
        else
                combine -M MultiDimFit -n el_2018_WGSF_$i           datacard_ele_2018.root  --setParameters WGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,WGSF -v3&
                combine -M MultiDimFit -n mu_2018_WGSF_$i           datacard_mu_2018.root   --setParameters WGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,WGSF -v3&
                combine -M MultiDimFit -n el_2018_ZGSF_$i           datacard_ele_2018.root  --setParameters ZGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,ZGSF -v3&
                combine -M MultiDimFit -n mu_2018_ZGSF_$i           datacard_mu_2018.root   --setParameters ZGSF=$i -s $x -t 300 --expectSignal=1 --redefineSignalPOIs r,nonPromptSF,ZGSF -v3&   
