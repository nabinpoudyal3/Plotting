...
combine -M FitDiagnostics -n CR1_2016     datacard_CR1_2016.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
combine -M FitDiagnostics -n CR2_2016     datacard_CR2_2016.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
combine -M FitDiagnostics -n CR3_2016     datacard_CR3_2016.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
...
combine -M FitDiagnostics -n CR1_2017     datacard_CR1_2017.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
combine -M FitDiagnostics -n CR2_2017     datacard_CR2_2017.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
combine -M FitDiagnostics -n CR3_2017     datacard_CR3_2017.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
...
combine -M FitDiagnostics -n CR1_2018     datacard_CR1_2018.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
combine -M FitDiagnostics -n CR2_2018     datacard_CR2_2018.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
combine -M FitDiagnostics -n CR3_2018     datacard_CR3_2018.txt   -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --robustFit=1 --saveNormalizations  &
