...
if [ $i == "0.4" ]; then 
        ...
        echo $x
        combine -M MultiDimFit -n el_2017_nonPrompt_$i datacard_ele_2017.dat --setParameters nonPromptSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
        combine -M MultiDimFit -n mu_2017_nonPrompt_$i datacard_mu_2017.dat  --setParameters nonPromptSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
...
if [ $i == "0.4" ]; then 
        ...
        echo $x
        combine -M MultiDimFit -n el_2017_$i datacard_ele_2017.dat -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3& 
        combine -M MultiDimFit -n mu_2017_$i datacard_mu_2017.dat  -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&        
done
