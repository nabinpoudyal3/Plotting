...
ValidateDatacards.py datacard_CR123_2017.txt --printLevel 3 --checkUncertOver 0.1

##convert Datacard into workspace
#text2workspace.py datacard_CR123_2017.txt -o workspace.root
...
combine -M FitDiagnostics datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --freezeNuisanceGroups mySyst 
combine -M FitDiagnostics datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --freezeParameters lumi

combine datacard_CR123_2017.root -M FitDiagnostics -t -1 --expectSignal 0 -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --minos all
...
combine datacard_CR123_2017.root -M FitDiagnostics -t -1 --expectSignal 2 -s 314159  --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF 
#--saveNormalizations --saveWithUncertainties --plots
python /uscms_data/d3/npoudyal/TTGammaSemiLeptonic13TeV/CMSSW_10_2_14/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py fitDiagnostics.root --all
root -l fitDiagnostics.root 
fit_b->Print()
...
#text2workspace.py  datacard_CR123_2017.root # saveworkspace while doing fitting and use the rootfile here to make impact plot
...
combine -M FitDiagnostics datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF --saveShapes --saveWithUncertainties --saveNormalizations --saveWorkspace

#Calculating the significance
#Signal strength measurement and uncertainty breakdown
#combine -M MultiDimFit datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF
# usually works for only one POI
combine -M MultiDimFit datacard_CR123_2017.root -s 314159  --rMin -5 --rMax 5 --algo grid --points 500 -n .Main
...
combine -M MultiDimFit datacard_CR123_2017.root -n .snapshot -s 314159 --rMin -5 --rMax 5 --saveWorkspace
...
##
#combine -M MultiDimFit datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF --rMin -1 --rMax 5 --algo grid --points 100 -n .Main
#combine -M MultiDimFit datacard_CR123_2017.root -s 314159 --algo grid --points 100
#root -l higgsCombine.Main.MultiDimFit.mH120.314159.root
#limit->Scan("r:deltaNLL")
...
#combine -M MultiDimFit datacard_CR123_2017.root -n .snapshot -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF --rMin -1 --rMax 5 --saveWorkspace
...
#combine -M FitDiagnostics datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --freezeNuisanceGroups mySyst 
#combine -M FitDiagnostics datacard_CR123_2017.root -s 314159 --redefineSignalPOIs r,ZGammaBkgPhotonSF,WGammaBkgPhotonSF -v2 --freezeParameters BTagSF_b
