...
set -x
    ...
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2018.root -m 125  --doInitialFit                                   $myFakeDataFit --redefineSignalPOIs   TTbarSF --robustFit=1 $myExpectSignal  $mySignalModifierRange  $myParameterRange 
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2018.root -m 125  --doFits                                         $myFakeDataFit --redefineSignalPOIs   TTbarSF --robustFit=1 $myExpectSignal  $mySignalModifierRange  $myParameterRange  --parallel 24
    # combineTool.py --cminPreScan -M Impacts -d datacard_"$channel"_2018.root -m 125  -o impacts_data_"$channel"_2018_TTbarSF.json     $myFakeDataFit --redefineSignalPOIs   TTbarSF --robustFit=1 $myExpectSignal  $mySignalModifierRange  $myParameterRange 
