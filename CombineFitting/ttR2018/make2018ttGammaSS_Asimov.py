...
#else:
ListOfFiles2018Ele  = ["fitDiagnostics.datacard_ele_2018.root"]
ListOfFiles2018Mu   = ["fitDiagnostics.datacard_mu_2018.root"]
ListOfFiles2018Both = ["fitDiagnostics.datacard_both_2018.root"]
