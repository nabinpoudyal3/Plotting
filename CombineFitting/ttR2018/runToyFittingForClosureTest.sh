...
if [ $i == "0.4" ]; then 
        ...
        echo $x
        combine -M MultiDimFit -n el_2018_nonPrompt_$i datacard_ele_2018.txt --setParameters nonPromptSF=$i -s $x -t 500 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v2&
        combine -M MultiDimFit -n mu_2018_nonPrompt_$i datacard_mu_2018.txt  --setParameters nonPromptSF=$i -s $x -t 500 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v2&
...
if [ $i == "0.4" ]; then 
        ...
        echo $x
        combine -M MultiDimFit -n el_2018_$i datacard_ele_2018.txt -s $x -t 500 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v2& 
        combine -M MultiDimFit -n mu_2018_$i datacard_mu_2018.txt  -s $x -t 500 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v2&        
done
