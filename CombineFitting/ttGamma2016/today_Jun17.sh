...
ValidateDatacards.py datacard_ele_2016.txt --printLevel 3 --checkUncertOver 0.1 --freezeNuisanceGroups mySyst
...
#combine -M MultiDimFit --algo grid --redefineSignalPOIs r -P ZGSF --setParameterRanges WGSF=-10,10 -d datacard_ele_2016.root --floatOtherPOIs 1
...
combine -M FitDiagnostics -n el_2016 datacard_ele_2016.root --plots --saveNLL --robustFit=1 -s 314159 --redefineSignalPOIs r,nonPromptSF --saveShapes --saveWithUncertainties --saveNormalizations -v1 --rMin=-5 --rMax=5 --setParameterRanges nonPromptSF=-10,10& #--freezeNuisanceGroups mySyst
#python mlfitNormsToText.py fitDiagnosticsel_2016.root --uncertainties

combine -M GenerateOnly -n .Gen_ele_2016 datacard_ele_2016.root --toys=1000 --toysFrequentist \
...
combine -M FitDiagnostics -n mu_2016 datacard_mu_2016.root --plots --saveNLL  --robustFit=1 -s 314159 --redefineSignalPOIs r,nonPromptSF --saveOverallShapes --saveWithUncertainties --saveNormalizations -v1 --rMin=-5 --rMax=5 --setParameterRanges nonPromptSF=-10,10& 
#python mlfitNormsToText.py fitDiagnosticsmu_2016.root --uncertainties

combine -M GenerateOnly -n .Gen_mu_2016 datacard_mu_2016.root --toys=1000 --toysFrequentist \
--expectSignal=1 --seed=314159 --redefineSignalPOIs r,nonPromptSF \
--rMin=-5 --rMax=5 -v0 --setParameterRanges nonPromptSF=-10,10 --saveToys 

combine -M FitDiagnostics -n .TOY_mu_2016 datacard_mu_2016.root --seed=314159 --redefineSignalPOIs r,nonPromptSF \
--saveWithUncertainties --saveNormalizations --saveToys  --plots --saveNLL --rMin=-5 --rMax=5 -v1 --setParameterRanges nonPromptSF=-10,10 \
--toysFile higgsCombine.Gen_mu_2016.GenerateOnly.mH120.314159.root \
--expectSignal=1
...
combine -M FitDiagnostics -n both_2016 datacard_both_2016.root --plots --saveNLL  --robustFit=1 -s 314159 --redefineSignalPOIs r,nonPromptSF --saveOverallShapes --saveWithUncertainties --saveNormalizations -v1 --rMin=-5 --rMax=5 --setParameterRanges nonPromptSF=-10,10 &
#python mlfitNormsToText.py fitDiagnosticsboth_2016.root --uncertainties

combine -M GenerateOnly -n .Gen_both_2016 datacard_both_2016.root --toys=1000 --toysFrequentist \
--expectSignal=1 --seed=314159 --redefineSignalPOIs r,nonPromptSF \
--rMin=-5 --rMax=5 -v0 --setParameterRanges nonPromptSF=-10,10 --saveToys 

combine -M FitDiagnostics -n .TOY_both_2016 datacard_both_2016.root --seed=314159 --redefineSignalPOIs r,nonPromptSF \
--saveWithUncertainties --saveNormalizations --saveToys  --plots --saveNLL --rMin=-5 --rMax=5 -v1 --setParameterRanges nonPromptSF=-10,10 \
--toysFile higgsCombine.Gen_both_2016.GenerateOnly.mH120.314159.root \
--expectSignal=1
