...
f1 = ROOT.TFile.Open('fitDiagnosticsele_2016.root','read')
...
canvas.SaveAs('totalCovariance_ttgamma_data_ele_2016.pdf') #########################################################
...
canvas.SaveAs('totalCovariance_ttgamma_data_mu_2016.pdf') #####################################################################
...
canvas.SaveAs('totalCovariance_ttgamma_data_both_2016.pdf') #####################################################################
...
canvas.SaveAs('totalCovariance_ttgamma_toy_ele_2016.pdf') #########################################################
...
canvas.SaveAs('totalCovariance_ttgamma_toy_mu_2016.pdf') #####################################################################
...
canvas.SaveAs('totalCovariance_ttgamma_toy_both_2016.pdf') #####################################################################
...
canvas.SaveAs('totalCovariance_ttgamma_Asimov_ele_2016.pdf') #########################################################
...
canvas.SaveAs('totalCovariance_ttgamma_Asimov_mu_2016.pdf') #####################################################################
...
canvas.SaveAs('totalCovariance_ttgamma_Asimov_both_2016.pdf') #####################################################################
