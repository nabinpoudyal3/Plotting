...
if [ $i == "0.4" ]; then 
        ...
        echo $x
        combine -M MultiDimFit -n el_2016_nonPrompt_$i datacard_ele_2016.txt --setParameters nonPromptSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
        combine -M MultiDimFit -n mu_2016_nonPrompt_$i datacard_mu_2016.txt  --setParameters nonPromptSF=$i -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&
...
if [ $i == "0.4" ]; then 
        ...
        echo $x
        combine -M MultiDimFit -n el_2016_$i datacard_ele_2016.txt -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3& 
        combine -M MultiDimFit -n mu_2016_$i datacard_mu_2016.txt  -s $x -t 300 --expectSignal=$i --redefineSignalPOIs r,nonPromptSF -v3&        
done
