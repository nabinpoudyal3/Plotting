...
parser.add_option("--moreSyst", dest="moreSyst", default="",type='str', help="")
...
# using weights evtWeight*prefireSF*PUweight*muEffWeight*eleEffWeight*1.0*1.0*1.0*1.0*btagWeight_1a
# using weights evtWeight*prefireSF*PUweight*muEffWeight*eleEffWeight*1.0*1.0*1.0*1.0*btagWeight_1a
...
if finalState=="Mu":
	...
	analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_Feb2021/%s/"%selYear 
	outputhistName = "histograms_%s/mu/%s"%(selYear, outputFileName)


	if moreSyst=="CR1" or moreSyst=="CR2" or moreSyst=="erdOn": 
		analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_Feb2021/Systematics/%s/%s_"%(selYear,moreSyst) 
		outputhistName = "histograms_%s/mu/%s"%(selYear, outputFileName)		
	...
	#			analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_17/13TeV_AnalysisNtuples/muons/%s_down_"%(syst)
		 #      outputhistName = "histograms_%s/mu/%s%s_down"%(selYear,outputFileName,syst)
			...
			if  level=="up":
				analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_Feb2021/Systematics/%s/"%selYear 
	...
	if sample=="QCD":
		sample = "QCDMu"
	analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_Feb2021/Dilepton/%s/"%selYear
	...
	#			analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_17/13TeV_AnalysisNtuples/muons/%s_down_"%(syst)
		 #      outputhistName = "histograms_%s/ele/%s%s_down"%(selYear,outputFileName,syst)
			...
			print "Running systematics ==>", syst
			if  level=="up":
				analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_Feb2021/Dilepton/Systematics/%s/"%selYear 
	...
	analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples_Feb2021/QCD_controlRegion/%s/"%selYear
...
# JER_up_ZZTo4L_2016_AnalysisNtuple.root
# JER_up_ZZ_2016_AnalysisNtuple.root
...
if not "QCD_DD" in sample:
	...
	if (syst=="elesmear" or syst=="phosmear" or syst=="elescale" or syst=="phoscale") and level=="up":
		print "==>",syst,level
		fileListTemp = ["{}{}".format("%s_up_"%syst,i) for i in fileListTemp]
	elif (syst=="elesmear" or syst=="phosmear" or syst=="elescale" or syst=="phoscale") and level=="down":
		print "==>",syst,level
	...
	if (syst=="Tune") and level=="up":
		print "==>",syst,level
		fileListTemp = ["{}{}".format("%sUp_"%syst,i) for i in fileListTemp]
	elif  (syst=="Tune") and level=="down":
		print "==>",syst,level
		fileListTemp = ["{}{}".format("%sDown_"%syst,i) for i in fileListTemp]
	...
	elementsToRemove = ["Dilep_Data_SingleEle_a_2016_AnalysisNtuple.root", "Dilep_Data_SingleEle_a_2016_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_a_2016_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_a_2016_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_a_2016_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_a_2016_AnalysisNtuple_5of5.root", 
						...
						"Dilep_Data_SingleEle_h_2017_AnalysisNtuple.root", "Dilep_Data_SingleEle_h_2017_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_h_2017_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_h_2017_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_h_2017_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_h_2017_AnalysisNtuple_5of5.root",  
						"Dilep_Data_SingleEle_g_2017_AnalysisNtuple.root", "Dilep_Data_SingleEle_g_2017_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_g_2017_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_g_2017_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_g_2017_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_g_2017_AnalysisNtuple_5of5.root",
						"Dilep_Data_SingleMu_a_2017_AnalysisNtuple.root",  "Dilep_Data_SingleMu_a_2017_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_a_2017_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_a_2017_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_a_2017_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_a_2017_AnalysisNtuple_5of5.root",    
						"Dilep_Data_SingleMu_h_2017_AnalysisNtuple.root",  "Dilep_Data_SingleMu_h_2017_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_h_2017_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_h_2017_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_h_2017_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_h_2017_AnalysisNtuple_5of5.root",   
						"Dilep_Data_SingleMu_g_2017_AnalysisNtuple.root",  "Dilep_Data_SingleMu_g_2017_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_g_2017_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_g_2017_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_g_2017_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_g_2017_AnalysisNtuple_5of5.root",    
						"Dilep_Data_SingleEle_e_2018_AnalysisNtuple.root", "Dilep_Data_SingleEle_e_2018_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_e_2018_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_e_2018_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_e_2018_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_e_2018_AnalysisNtuple_5of5.root",   
						"Dilep_Data_SingleEle_f_2018_AnalysisNtuple.root", "Dilep_Data_SingleEle_f_2018_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_f_2018_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_f_2018_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_f_2018_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_f_2018_AnalysisNtuple_5of5.root",   
						"Dilep_Data_SingleEle_g_2018_AnalysisNtuple.root", "Dilep_Data_SingleEle_g_2018_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_g_2018_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_g_2018_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_g_2018_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_g_2018_AnalysisNtuple_5of5.root",    
						"Dilep_Data_SingleEle_h_2018_AnalysisNtuple.root", "Dilep_Data_SingleEle_h_2018_AnalysisNtuple_1of5.root", "Dilep_Data_SingleEle_h_2018_AnalysisNtuple_2of5.root", "Dilep_Data_SingleEle_h_2018_AnalysisNtuple_3of5.root", "Dilep_Data_SingleEle_h_2018_AnalysisNtuple_4of5.root", "Dilep_Data_SingleEle_h_2018_AnalysisNtuple_5of5.root",      
						"Dilep_Data_SingleMu_e_2018_AnalysisNtuple.root",  "Dilep_Data_SingleMu_e_2018_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_e_2018_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_e_2018_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_e_2018_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_e_2018_AnalysisNtuple_5of5.root",  
						"Dilep_Data_SingleMu_f_2018_AnalysisNtuple.root",  "Dilep_Data_SingleMu_f_2018_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_f_2018_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_f_2018_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_f_2018_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_f_2018_AnalysisNtuple_5of5.root",      
						"Dilep_Data_SingleMu_g_2018_AnalysisNtuple.root",  "Dilep_Data_SingleMu_g_2018_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_g_2018_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_g_2018_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_g_2018_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_g_2018_AnalysisNtuple_5of5.root",     
						"Dilep_Data_SingleMu_h_2018_AnalysisNtuple.root",  "Dilep_Data_SingleMu_h_2018_AnalysisNtuple_1of5.root",  "Dilep_Data_SingleMu_h_2018_AnalysisNtuple_2of5.root",  "Dilep_Data_SingleMu_h_2018_AnalysisNtuple_3of5.root",  "Dilep_Data_SingleMu_h_2018_AnalysisNtuple_4of5.root",  "Dilep_Data_SingleMu_h_2018_AnalysisNtuple_5of5.root",    
						"Data_SingleEle_a_2016_AnalysisNtuple.root",       "Data_SingleEle_a_2016_AnalysisNtuple_1of5.root",       "Data_SingleEle_a_2016_AnalysisNtuple_2of5.root",       "Data_SingleEle_a_2016_AnalysisNtuple_3of5.root",       "Data_SingleEle_a_2016_AnalysisNtuple_4of5.root",       "Data_SingleEle_a_2016_AnalysisNtuple_5of5.root",            
						"Data_SingleMu_a_2016_AnalysisNtuple.root",        "Data_SingleMu_a_2016_AnalysisNtuple_1of5.root",        "Data_SingleMu_a_2016_AnalysisNtuple_2of5.root",        "Data_SingleMu_a_2016_AnalysisNtuple_3of5.root",        "Data_SingleMu_a_2016_AnalysisNtuple_4of5.root",        "Data_SingleMu_a_2016_AnalysisNtuple_5of5.root",               
						"Data_SingleEle_a_2017_AnalysisNtuple.root",       "Data_SingleEle_a_2017_AnalysisNtuple_1of5.root",       "Data_SingleEle_a_2017_AnalysisNtuple_2of5.root",       "Data_SingleEle_a_2017_AnalysisNtuple_3of5.root",       "Data_SingleEle_a_2017_AnalysisNtuple_4of5.root",       "Data_SingleEle_a_2017_AnalysisNtuple_5of5.root",               
						"Data_SingleEle_h_2017_AnalysisNtuple.root",       "Data_SingleEle_h_2017_AnalysisNtuple_1of5.root",       "Data_SingleEle_h_2017_AnalysisNtuple_2of5.root",       "Data_SingleEle_h_2017_AnalysisNtuple_3of5.root",       "Data_SingleEle_h_2017_AnalysisNtuple_4of5.root",       "Data_SingleEle_h_2017_AnalysisNtuple_5of5.root",               
						"Data_SingleEle_g_2017_AnalysisNtuple.root",       "Data_SingleEle_g_2017_AnalysisNtuple_1of5.root",       "Data_SingleEle_g_2017_AnalysisNtuple_2of5.root",       "Data_SingleEle_g_2017_AnalysisNtuple_3of5.root",       "Data_SingleEle_g_2017_AnalysisNtuple_4of5.root",       "Data_SingleEle_g_2017_AnalysisNtuple_5of5.root",                
						"Data_SingleMu_a_2017_AnalysisNtuple.root",        "Data_SingleMu_a_2017_AnalysisNtuple_1of5.root",        "Data_SingleMu_a_2017_AnalysisNtuple_2of5.root",        "Data_SingleMu_a_2017_AnalysisNtuple_3of5.root",        "Data_SingleMu_a_2017_AnalysisNtuple_4of5.root",        "Data_SingleMu_a_2017_AnalysisNtuple_5of5.root",                
						"Data_SingleMu_h_2017_AnalysisNtuple.root",        "Data_SingleMu_h_2017_AnalysisNtuple_1of5.root",        "Data_SingleMu_h_2017_AnalysisNtuple_2of5.root",        "Data_SingleMu_h_2017_AnalysisNtuple_3of5.root",        "Data_SingleMu_h_2017_AnalysisNtuple_4of5.root",        "Data_SingleMu_h_2017_AnalysisNtuple_5of5.root",              
						"Data_SingleMu_g_2017_AnalysisNtuple.root",        "Data_SingleMu_g_2017_AnalysisNtuple_1of5.root",        "Data_SingleMu_g_2017_AnalysisNtuple_2of5.root",        "Data_SingleMu_g_2017_AnalysisNtuple_3of5.root",        "Data_SingleMu_g_2017_AnalysisNtuple_4of5.root",        "Data_SingleMu_g_2017_AnalysisNtuple_5of5.root",              
						"Data_SingleEle_e_2018_AnalysisNtuple.root",       "Data_SingleEle_e_2018_AnalysisNtuple_1of5.root",       "Data_SingleEle_e_2018_AnalysisNtuple_2of5.root",       "Data_SingleEle_e_2018_AnalysisNtuple_3of5.root",       "Data_SingleEle_e_2018_AnalysisNtuple_4of5.root",       "Data_SingleEle_e_2018_AnalysisNtuple_5of5.root",           
						"Data_SingleEle_f_2018_AnalysisNtuple.root",       "Data_SingleEle_f_2018_AnalysisNtuple_1of5.root",       "Data_SingleEle_f_2018_AnalysisNtuple_2of5.root",       "Data_SingleEle_f_2018_AnalysisNtuple_3of5.root",       "Data_SingleEle_f_2018_AnalysisNtuple_4of5.root",       "Data_SingleEle_f_2018_AnalysisNtuple_5of5.root",           
						"Data_SingleEle_g_2018_AnalysisNtuple.root",       "Data_SingleEle_g_2018_AnalysisNtuple_1of5.root",       "Data_SingleEle_g_2018_AnalysisNtuple_2of5.root",       "Data_SingleEle_g_2018_AnalysisNtuple_3of5.root",       "Data_SingleEle_g_2018_AnalysisNtuple_4of5.root",       "Data_SingleEle_g_2018_AnalysisNtuple_5of5.root",             
						"Data_SingleEle_h_2018_AnalysisNtuple.root",       "Data_SingleEle_h_2018_AnalysisNtuple_1of5.root",       "Data_SingleEle_h_2018_AnalysisNtuple_2of5.root",       "Data_SingleEle_h_2018_AnalysisNtuple_3of5.root",       "Data_SingleEle_h_2018_AnalysisNtuple_4of5.root",       "Data_SingleEle_h_2018_AnalysisNtuple_5of5.root",             
						"Data_SingleMu_e_2018_AnalysisNtuple.root",        "Data_SingleMu_e_2018_AnalysisNtuple_1of5.root",        "Data_SingleMu_e_2018_AnalysisNtuple_2of5.root",        "Data_SingleMu_e_2018_AnalysisNtuple_3of5.root",        "Data_SingleMu_e_2018_AnalysisNtuple_4of5.root",        "Data_SingleMu_e_2018_AnalysisNtuple_5of5.root",           
						"Data_SingleMu_f_2018_AnalysisNtuple.root",        "Data_SingleMu_f_2018_AnalysisNtuple_1of5.root",        "Data_SingleMu_f_2018_AnalysisNtuple_2of5.root",        "Data_SingleMu_f_2018_AnalysisNtuple_3of5.root",        "Data_SingleMu_f_2018_AnalysisNtuple_4of5.root",        "Data_SingleMu_f_2018_AnalysisNtuple_5of5.root",               
						"Data_SingleMu_g_2018_AnalysisNtuple.root",        "Data_SingleMu_g_2018_AnalysisNtuple_1of5.root",        "Data_SingleMu_g_2018_AnalysisNtuple_2of5.root",        "Data_SingleMu_g_2018_AnalysisNtuple_3of5.root",        "Data_SingleMu_g_2018_AnalysisNtuple_4of5.root",        "Data_SingleMu_g_2018_AnalysisNtuple_5of5.root",            
						"Data_SingleMu_h_2018_AnalysisNtuple.root",        "Data_SingleMu_h_2018_AnalysisNtuple_1of5.root",        "Data_SingleMu_h_2018_AnalysisNtuple_2of5.root",        "Data_SingleMu_h_2018_AnalysisNtuple_3of5.root",        "Data_SingleMu_h_2018_AnalysisNtuple_4of5.root",        "Data_SingleMu_h_2018_AnalysisNtuple_5of5.root",                  
...
if options.verbose: print '>>>>>>>> Event weight string: "%s"'%evtWeight
