...
for year in ${YEAR[@]}; do
	callTrain
	python makePlots.py -y $year -c Ele --tight            --noQCD --allPlots --testdir     
	python makePlots.py -y $year -c Mu  --tight            --noQCD --allPlots --testdir  

	python makePlots.py -y $year -c Ele --looseCRge4e0     --noQCD --allPlots --testdir  
	python makePlots.py -y $year -c Mu  --looseCRge4e0     --noQCD --allPlots --testdir  
