...
for val in ${StringArray[@]}; do
    python makePlots_ZJets.py -c DiMu   -y 2016 --useQCDMC --$val &
    python makePlots_ZJets.py -c DiEle  -y 2016 --useQCDMC --$val &
    python makePlots_ZJets.py -c DiMu   -y 2017 --useQCDMC --$val &
    python makePlots_ZJets.py -c DiEle  -y 2017 --useQCDMC --$val &
    python makePlots_ZJets.py -c DiMu   -y 2018 --useQCDMC --$val &
    python makePlots_ZJets.py -c DiEle  -y 2018 --useQCDMC --$val &
