...
for year in ${YEAR[@]}; do   
	python makePlots_TTGamma_DD.py  -y $year   -c Ele   --ChIsoPlot  --datadriven
	python makePlots_TTGamma_DD.py  -y $year   -c Mu    --ChIsoPlot  --datadriven
done
...
#########CHECK THIS ONE
# makeTemplateForTTGamma_Additional.sh
