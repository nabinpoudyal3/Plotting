...
declare -a SYSTEMATICS=("BTagSF_b" "BTagSF_l" "PU" "MuEff" "EleEff" "PhoEff" "Q2" "isr" "fsr" "prefireEcal" "misIDE")
...
for year in ${YEAR[@]}; do    
	echo python makePlot_M3Control.py -y $year   -c Ele   --zeroPhoton  --template   
